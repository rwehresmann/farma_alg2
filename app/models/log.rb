class Log
  ...
  def self.log_add_tag(user_id, answer_id, tag_id)
    Log.create(type: "TAG_ADD", params: { answer_id: answer_id,
               tag_id: tag_id }, user_id: user_id)
  end

  def self.log_accept_tag(user_id, answer_id, tag_id)
    Log.create(type: "TAG_ACCEPT", params: { answer_id: answer_id,
               tag_id: tag_id }, user_id: user_id)
  end

  def self.log_remove_tag(user_id, answer_id, tag_id)
    Log.create(type: "TAG_REMOVE", params: { answer_id: answer_id,
               tag_id: tag_id }, user_id: user_id)
  end

  def self.log_reject_tag(user_id, answer_id, tag_id)
    Log.create(type: "TAG_REJECT", params: { answer_id: answer_id,
              tag_id: tag_id }, user_id: user_id)
  end
  ...
  def self.log_graph_add_similar(user_id, answer_id)
    Log.create(type: "GRAPH_ADD_SIMILAR", params: { answer_id: answer_id},
               user_id: user_id)
  end

  def self.log_graph_add_connected_component(user_id, answer_id)
    Log.create(type: "GRAPH_ADD_CONNECTED", params: { answer_id: answer_id },
               user_id: user_id)
  end

  def self.log_graph_add(user_id, answer_id)
    Log.create(type: "GRAPH_ADD", params: { answer_id: answer_id },
               user_id: user_id)
  end

  # 'answer_ids' is a hash.
  ...
  def self.log_team_view(user_id, team_id)
    Log.create(type: "TEAM_VIEW", params: { team_id: team_id },
               user_id: user_id)
  end

  # Q: user2_id ?
  def self.log_team_user_view(user_id, team_id, user2_id)
    Log.create(type: "TEAM_USER_VIEW", params: { team_id: team_id,
               user_id: user2_id }, user_id: user_id)
  end

  def self.log_team_user_lo_view(user_id,team_id,user2_id,lo_id)
    Log.create(type: "TEAM_USER_LO_VIEW", params: { team_id: team_id,
               user_id: user2_id, lo_id: lo_id }, user_id: user_id)
  end

  def self.log_team_user_lo_question_view(user_id, team_id, user2_id, lo_id, question_id)
    Log.create(type: "TEAM_USER_LO_QUESTION_VIEW", params: { team_id: team_id,
               user_id: user2_id, lo_id: lo_id, question_id: question_id },
               user_id: user_id)
  end

  def self.log_team_lo_overview_view(user_id, team_id, lo_id)
    Log.create(type: "TEAM_LO_OVERVIEW_VIEW", params: { team_id: team_id,
               lo_id: lo_id }, user_id: user_id)
  end
end
